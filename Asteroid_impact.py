...
class Asteroid:
    ...
    def asteroid_density(self, asteroid_material):
        if asteroid_material == "metal":
            asteroid_density = 6000
        elif asteroid_material == "rocky":
            asteroid_density = 2500
        else:
            print("This type of asteroids does not exist")
            return None
        return asteroid_density
...
d = float(input("Enter the diameter of the asteroid: "))
s = float(input("Enter the speed of the asteroid: "))
a = float(input("Enter the angle at which the asteroid hit the Earth: "))
obj = Asteroid(d, s, a)
...
if asteroid_mass is not None and kinetic_energy is not None and crater_diameter is not None:
    # Print the results
    print("The mass of the asteroid is:", asteroid_mass)
    print("The kinetic energy of the asteroid is:", kinetic_energy)
    print("The diameter of the crater formed is:", crater_diameter)
    """